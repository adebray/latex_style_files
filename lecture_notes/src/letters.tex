...
\newcommand{\Spinc}{\relax\ifmmode\mathrm{Spin}^c\else spin\textsuperscript{$c$}\xspace\fi}
\newcommand{\Pinc}{\relax\ifmmode\mathrm{Pin}^c\else pin\textsuperscript{$c$}\xspace\fi}
